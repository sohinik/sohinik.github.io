...
$(document).ready(function () {
  // Adapted from https://www.seancdavis.com/posts/wait-until-all-images-loaded/
  // Check when header image is loaded
  $("#landing").each(function (idx, img) {
    $("<img>").on("load", headersImageLoaded).attr("src", $(img).attr("src"));
  });
  function headersImageLoaded() {
